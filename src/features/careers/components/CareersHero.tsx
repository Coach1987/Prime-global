...
export function CareersHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(145deg,rgba(12,24,41,0.94),rgba(8,16,29,0.96))] px-6 py-12 shadow-[0_30px_90px_rgba(0,0,0,0.45)] sm:px-10 sm:py-16">
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(circle_at_18%_22%,rgba(130,192,255,0.16),transparent_42%),radial-gradient(circle_at_86%_16%,rgba(201,162,75,0.12),transparent_35%)]"
      />
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mt-8">
          <Link
            href="/careers/apply"
            className="inline-flex min-h-[52px] items-center justify-center rounded-full border border-gold/40 bg-gradient-to-r from-[#C9A24B] via-[#D6B66A] to-[#A77F2F] px-8 py-3 text-[15px] font-semibold text-[#07111D] shadow-[0_18px_48px_rgba(201,162,75,0.28)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_56px_rgba(201,162,75,0.36)]"
          >
            {t("cta")}
          </Link>
        </div>
