...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "serviceDetails.logistics" });

  return {
    title: t("title"),
    description: t("intro"),
    alternates: { canonical: `/${locale}/services/logistics` },
  };
}
...
export default async function LogisticsServicePage({
  ...
  const capabilities = ["planning", "coordination", "visibility", "compliance"] as const;
  const reasons = ["discipline", "speed", "clarity"] as const;
