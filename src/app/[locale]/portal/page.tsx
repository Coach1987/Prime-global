      ...
      <section className="rounded-3xl border border-gold/20 bg-bg-secondary/80 p-7 backdrop-blur-xl md:p-10">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <article className="rounded-2xl border border-gold/15 bg-bg-primary/70 p-5">
            ...
            <Link href={`/${locale}/employers/login`} className="mt-4 inline-flex rounded-full border border-gold/30 px-4 py-2 text-sm font-semibold text-gold">Open Interview Center</Link>
          </article>
          ...
          <article className="rounded-2xl border border-gold/15 bg-bg-primary/70 p-5">
            ...
            <Link href={`/${locale}/admin/login`} className="mt-4 inline-flex rounded-full border border-gold/30 px-4 py-2 text-sm font-semibold text-gold">Open Control Center</Link>
          </article>
        </div>
      </section>
    </main>
