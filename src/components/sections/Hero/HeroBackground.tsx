export function HeroBackground() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/IMG_20260711_110755.jpg')] bg-[length:180%_auto] bg-[position:center_-220px] bg-no-repeat opacity-22 [filter:saturate(0)_contrast(1.14)_brightness(0.72)] sm:bg-[position:center_-300px] md:bg-[position:center_-360px] lg:bg-[position:center_-430px]" />
