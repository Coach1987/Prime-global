...
] bg-[linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:54px_54px]" />

      <div className="absolute left-[-20%] top-[10%] h-[520px] w-[520px] rounded-full bg-[#c9a24b]/12
 blur-[120px]" />
      <div className="absolute right-[-25%] top-[25%] h-[560px] w-[560px] rounded-full bg-[#1d5f8f]/20 blur-[130px]" />

      <div className="absolute left-1/2 top-[42%] h-[420px] w-[900px] -translate-x-1/2 rounded-full border border-[#c9a24b]/10 rotate-[-12deg]" />
