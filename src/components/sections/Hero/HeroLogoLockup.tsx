  ...
  return (
    <div className="relative mx-auto flex w-full items-center justify-center px-0">
      <div className="relative aspect-[1.26/1] w-[min(102vw,760px)] max-w-[760px] sm:w-[min(90vw,720px)] sm:max-w-[720px] lg:w-[min(76vw,780px)] lg:max-w-[780px]">
        <div className="absolute inset-[-7%] rounded-full bg-[radial-gradient(circle_at_50%_40%,rgba(69,172,255,0.42),transparent_56%),radial-gradient(circle_at_50%_44%,rgba(112,198,255,0.19),transparent_40%),radial-gradient(circle_at_49%_36%,rgba(204,214,226,0.16),transparent_46%)] blur-[34px]" />
