  ...
  return (
    <section id="industries" className="relative isolate overflow-hidden bg-[#030712] py-24 md:py-36">
      <div aria-hidden="true" className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(201,162,75,0.12),transparent_45%),linear-gradient(180deg,#030712_0%,#07131f_50%,#040a13_100%)]" />
