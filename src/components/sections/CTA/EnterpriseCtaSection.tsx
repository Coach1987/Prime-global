...
export function EnterpriseCtaSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#040b13] py-24 md:py-32">
      <div aria-hidden="true" className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_center,rgba(90,166,255,0.16),transparent_48%)]" />
        ...
        <div className="rounded-[32px] border border-blue-300/20 bg-[linear-gradient(135deg,rgba(255,255,255,0.07),rgba(255,255,255,0.02))] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.24)] backdrop-blur-2xl sm:p-10 lg:p-12">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-[10px] border border-white/15 bg-white/[0.03] px-7 py-[14px] text-[14px] font-semibold text-text-primary transition-all duration-300 hover:border-blue-300/40 hover:bg-blue-500/[0.08]"
            >
              {t("secondaryCta")}
            </button>
          </div>
