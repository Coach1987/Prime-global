  ...
  theme: {
    extend: {
      colors: {
        ...
        gold: {
          DEFAULT: "rgb(var(--pg-accent-rgb) / <alpha-value>)",
          bright: "rgb(var(--pg-accent-bright-rgb) / <alpha-value>)",
          muted: "rgb(var(--pg-accent-muted-rgb) / <alpha-value>)",
        },
        accent: {
          primary: "rgb(var(--pg-accent-rgb) / <alpha-value>)",
          bright: "rgb(var(--pg-accent-bright-rgb) / <alpha-value>)",
        },
        metallic: {
          1: "rgb(var(--pg-metallic-1-rgb) / <alpha-value>)",
          2: "rgb(var(--pg-metallic-2-rgb) / <alpha-value>)",
        },
        warmwhite: "rgb(var(--pg-text-primary-rgb) / <alpha-value>)",
        text: {
          primary: "rgb(var(--pg-text-primary-rgb) / <alpha-value>)",
          secondary: "rgb(var(--pg-text-secondary-rgb) / <alpha-value>)",
          tertiary: "#6B7280",
        },
        whatsapp: "#25D366",
      },
